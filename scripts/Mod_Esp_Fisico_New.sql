...
BEGIN
    ...
    SET NEW.Status_Retirada = 0; -- Defina o status padrão, se necessário
END;
//
DELIMITER ;
...
-- INSERT INTO Cliente (Id_Cliente, Nome_Cliente, Telefone_Cliente, Email_Cliente, Qtd_pontos_Cliente, Prazo_Cliente, Valor_mensal_Cliente, Status_Cliente, Endereco_Id_Endereco, Admin_Id_Admin, Recepcao_Id_recepcao, EnderecoFiscal_Num_End_Fiscal)
-- VALUES (1, 'Cliente Teste', '123456789', 'cliente@teste.com', 0, '2023-01-01', 1000.00, 1, 1, 1, 1, 1);

-- UPDATE Cliente
-- SET Nome_Cliente = 'Novo Nome', Telefone_Cliente = '987654321'
-- WHERE Id_Cliente = 1;
